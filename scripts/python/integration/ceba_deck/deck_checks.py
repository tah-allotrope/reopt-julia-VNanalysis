...
A: list[Check] = [
    ...
    _line(
        "A02_tou_peak_normal_ratio_22_110kv",
        slide=5,
        bucket="A",
        ...
        assumptions=[
            ...
            "Deck's 1.80 from 0.126/0.070 in the deck Slide 5 voltage table.",
        ],
    ),
    _line(
        ...
        deck_value=2204.0,
        deck_unit="VND/kWh",
        citation="EAVCED public training (deck slide 11)",
    ...
    _line(
        ...
        deck_value=523.3,
        deck_unit="VND/kWh",
        citation="EAVCED public training (deck slide 11, 30)",
        ...
        assumptions=[
            ...
            "Deck slides 9, 11, 13, 30, 37, 175, 356 all reference 360 + 163.3 = 523.",
        ],
    ),
    _line(
        "A06_k_loss_factor",
    ...
    _line(
        ...
        assumptions=[
            "Deck Slide 19 lists the range 12-15%+; engine default 0.15 falls within the deck's range.",
            "Qualitative check — value comparison is meaningless because target_irr_fraction is a tunable knob, not an authoritative value.",
        ],
    ),
    _line(
        "A16_cit_holiday",
...
B: list[Check] = [
    _line(
        ...
        deck_unit="VND/month",
        citation="EAVCED public training (deck slide 11, 37)",
