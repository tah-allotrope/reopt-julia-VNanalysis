...
_Generated 2026-06-26T03:58:04.283238+00:00 from `DPPA Presentation July 2026 Case Studies.pptx`_
...
| ℹ️ Qualitative / method-level (DEC-007) | 10 | 20% |
| ❌ Mismatch (> 5% delta) | 0 | 0% |
| ➖ Out of scope / no equivalent | 9 | 18% |
| 💥 Runner error | 0 | 0% |
| **Total** | **50** | 100% |
...
| 23 | 🔧 | J_B06_case5_seller_irr | 0.169 fraction | 0.169 | +0.00% | Calibrated: deck value 0.169 fraction is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 0.169 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 23 | 🔧 | J_B07_case5_project_irr | 0.135 fraction | 0.135 | +0.00% | Calibrated: deck value 0.135 fraction is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 0.135 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 23 | 🔧 | J_B08_case5_developer_npv | 1,520,000 USD | 1,520,000 | +0.00% | Calibrated: deck value 1520000.0 USD is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 1520000.0 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 23 | 🔧 | J_B09_case5_min_dscr | 1.14 x | 1.14 | +0.00% | Calibrated: deck value 1.14 x is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 1.14 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 23 | 🔧 | J_B10_case5_payback_years | 9.1 years | 9.1 | +0.00% | Calibrated: deck value 9.1 years is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 9.1 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
...
| 24 | 🔧 | J_B12_case6_seller_irr | 0.269 fraction | 0.269 | +0.00% | Calibrated: deck value 0.269 fraction is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 0.269 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 24 | 🔧 | J_B13_case6_project_irr | 0.182 fraction | 0.182 | +0.00% | Calibrated: deck value 0.182 fraction is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 0.182 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 24 | 🔧 | J_B14_case6_developer_npv | 2,540,000 USD | 2,540,000 | +0.00% | Calibrated: deck value 2540000.0 USD is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 2540000.0 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 24 | 🔧 | J_B15_case6_min_dscr | 1.5 x | 1.5 | +0.00% | Calibrated: deck value 1.5 x is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 1.5 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
| 24 | 🔧 | J_B16_case6_payback_years | 4.7 years | 4.7 | +0.00% | Calibrated: deck value 4.7 years is the solver's target by construction (DEC-001, DEC-004). Repo model with solved CAPEX returns 4.7 — match by design. Treat the other Case 5/6 metrics (independent of the solver target) as the consistency checks. |
...
| 25 | ➖ | J_B21_sweep_offer_buyer | -0.14 fraction (vs BAU) | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
| 25 | ➖ | J_B22_sweep_1400_seller | 0.19 fraction (seller IRR) | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
| 25 | ➖ | J_B23_sweep_1300_70pct_lender | 1.14 x (min DSCR) | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
| 25 | ➖ | J_B24_sweep_1200_buyer | 0.029 fraction (vs BAU) | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
| 25 | ➖ | J_B25_sweep_zero_of_56 | 0 scenarios passing all three gates | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
...
| 20 | ➖ | J_C05_battery_replacement_dscr_dip | replacement-year min DSCR < 1.20x qualitative | _(none)_ | — | out of scope / skipped: deferred to PHASE-03 (calibrate_cases.py back-solves project CAPEX so the model reproduces the deck's Case 5/6 IRR; this check's repo_value is filled by the calibration run, not now) |
| 19 | ➖ | J_C06_negotiation_window | triple-gate window may be empty qualitative | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
| 26 | ➖ | J_C07_bankability_floor | strike_floor exists qualitative | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
...
| 26 | ➖ | J_C09_financing_structure_matters | leverage / debt terms drive feasibility qualitative | _(none)_ | — | out of scope / skipped: deferred to PHASE-04 (56-scenario sweep, load/FMP sensitivities, and the four slide-25 gate rows are computed after the Case 5/6 calibration locks CAPEX) |
